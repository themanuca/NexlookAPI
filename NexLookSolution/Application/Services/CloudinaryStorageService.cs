...
namespace Application.Services
{
    public class CloudinaryStorageService : IStorageService
    {
        ...
        {
            _logger.LogWarning("DeleteFirebaseAsync chamado mas Firebase não está implementado. PublicId: {PublicId}", publicId);
        ...
        {
            _logger.LogWarning("UploadFirebaseAsync chamado mas Firebase não está implementado.");
            return Task.FromResult(new StorageUploadResult
            {
                Success = false,
                ErrorMessage = "Firebase storage não está disponível."
            });
        }
    }
}
