    ...
    public class UploadImagemController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadImagem([FromForm] RoupaItem roupaItem)
        {
            try
            {
                ...
                _logger.LogInformation("Iniciando upload de imagem. UserId: {UserId}", userId);
        ...
        public async Task<IActionResult> GetAllImages()
        {
            ...
            {
                var userId = GetUserId();
                _logger.LogInformation("Iniciando busca de imagens. UserId: {UserId}", userId);
        ...
        public async Task<IActionResult> ExcluirLook(Guid lookId)
        {
            ...
            {
                var userId = GetUserId();
                _logger.LogInformation("Iniciando exclusão de look. LookId: {LookId}, UserId: {UserId}", lookId, userId);
